...
import { testProviderConfig } from '@/lib/api'
...
const PROVIDER_TYPES = [
  { value: 'anthropic_compatible' as const, label: 'Anthropic-compatible', experimental: false },
  { value: 'openai_compatible' as const, label: 'OpenAI-compatible', experimental: true },
  { value: 'custom' as const, label: 'Custom', experimental: false },
]
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-[var(--border)]">
          <h2 className="text-lg font-semibold">
            {step === 1 ? t('modal.chooseType') : t('provider.add')}
          </h2>
          <button
            onClick={onClose}
          ...
          <div className="p-6">
            ...
            {step === 2 && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="label">{t('provider.notes')}</label>
              ...
              {step === 2 && (
                <>
                  ...
                  >
                    ...
                    {isTesting ? 'Testing...' : t('provider.test')}
                  </button>
