...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'detail.runtimeModelHint': 'Windows launchers now start Claude with a per-profile --settings file that points at Clair local proxy. Use the evidence below to confirm the rewritten upstream model.',
    'detail.type': 'Type',
    ...
    'detail.wrapperReady': 'Launcher is current',
    'detail.wrapperStale': 'Launcher is stale. Regenerate before using it.',
    'detail.wrapperMissing': 'Launcher is missing. Generate it first.',
  ...
  zh: {
    ...
    'detail.runtimeModelHint': 'Windows 启动器现在会通过每个 Profile 自己的 --settings 文件启动 Claude，并把请求指向 Clair 本地代理。下面的证据可以确认真实改写后的上游模型。',
    'detail.type': '类型',
    ...
    'detail.wrapperReady': '启动器已是最新状态',
    'detail.wrapperStale': '启动器已过期，请重新生成后再使用',
    'detail.wrapperMissing': '启动器不存在，请先生成',
